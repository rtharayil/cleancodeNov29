...
public class Employee
{
    public Datetime startDate { get; set; } // get set Start Working Date
    public Datetime modificationTime { get; set; } // get set Modification Time
}
=======
public class Employee
{
    public Datetime joiningDate { get; set; } // get set Start Working Date
    public Datetime modificationTime { get; set; } // get set Modification Time
}
>>>>>>> 208bc8570630a7295e875546de1f009b4cfbd1d9
